...
{
       8,     0,    -1,     8,     9,    -1,     9,    -1,    10,     6,
      -1,     6,    -1,    10,    11,    -1,    11,    -1,     3,    -1,
       4,    -1,     5,    -1
};
...
{
  "$end", "error", "$undefined", "KEYWORD", "IDENTIFIER", "OPERATOR",
  "NEWLINE", "$accept", "program", "line", "tokens", "token", 0
};
#endif
